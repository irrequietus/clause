...
#if defined(PPMPF_VXPP_I7D1)
    #if PPMPF_VXPP_I7D1 == 0
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 1
    #elif PPMPF_VXPP_I7D1 == 1
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 2
    #elif PPMPF_VXPP_I7D1 == 2
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 3
    #elif PPMPF_VXPP_I7D1 == 3
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 4
    #elif PPMPF_VXPP_I7D1 == 4
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 5
    #elif PPMPF_VXPP_I7D1 == 5
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 6
    #elif PPMPF_VXPP_I7D1 == 6
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 7
    #elif PPMPF_VXPP_I7D1 == 7
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 8
    #elif PPMPF_VXPP_I7D1 == 8
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 9
    #elif PPMPF_VXPP_I7D1 == 9
        #undef PPMPF_VXPP_I7D1
        #define PPMPF_VXPP_I7D1 0
        #define PPMPF_VXPP_I7CARRY
    #endif
#else
    #error "unexpected preprocessor error on PPMPF_VXPP_I7D1"
#endif
