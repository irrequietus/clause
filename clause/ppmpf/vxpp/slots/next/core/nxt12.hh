...
#if defined(PPMPF_VXPP_I1D2)
    #if PPMPF_VXPP_I1D2 == 0
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 1
    #elif PPMPF_VXPP_I1D2 == 1
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 2
    #elif PPMPF_VXPP_I1D2 == 2
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 3
    #elif PPMPF_VXPP_I1D2 == 3
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 4
    #elif PPMPF_VXPP_I1D2 == 4
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 5
    #elif PPMPF_VXPP_I1D2 == 5
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 6
    #elif PPMPF_VXPP_I1D2 == 6
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 7
    #elif PPMPF_VXPP_I1D2 == 7
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 8
    #elif PPMPF_VXPP_I1D2 == 8
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 9
    #elif PPMPF_VXPP_I1D2 == 9
        #undef PPMPF_VXPP_I1D2
        #define PPMPF_VXPP_I1D2 0
        #define PPMPF_VXPP_I1CARRY
    #endif
#else
    #error "unexpected preprocessor error on PPMPF_VXPP_I1D2"
#endif
