...
#if defined(PPMPF_VXPP_I2D3)
    #if PPMPF_VXPP_I2D3 == 0
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 1
    #elif PPMPF_VXPP_I2D3 == 1
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 2
    #elif PPMPF_VXPP_I2D3 == 2
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 3
    #elif PPMPF_VXPP_I2D3 == 3
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 4
    #elif PPMPF_VXPP_I2D3 == 4
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 5
    #elif PPMPF_VXPP_I2D3 == 5
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 6
    #elif PPMPF_VXPP_I2D3 == 6
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 7
    #elif PPMPF_VXPP_I2D3 == 7
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 8
    #elif PPMPF_VXPP_I2D3 == 8
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 9
    #elif PPMPF_VXPP_I2D3 == 9
        #undef PPMPF_VXPP_I2D3
        #define PPMPF_VXPP_I2D3 0
        #define PPMPF_VXPP_I2CARRY
    #endif
#else
    #error "unexpected preprocessor error on PPMPF_VXPP_I2D3"
#endif
