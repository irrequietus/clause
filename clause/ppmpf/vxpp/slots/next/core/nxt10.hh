...
#if defined(PPMPF_VXPP_I1D0)
    #if PPMPF_VXPP_I1D0 == 0
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 1
    #elif PPMPF_VXPP_I1D0 == 1
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 2
    #elif PPMPF_VXPP_I1D0 == 2
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 3
    #elif PPMPF_VXPP_I1D0 == 3
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 4
    #elif PPMPF_VXPP_I1D0 == 4
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 5
    #elif PPMPF_VXPP_I1D0 == 5
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 6
    #elif PPMPF_VXPP_I1D0 == 6
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 7
    #elif PPMPF_VXPP_I1D0 == 7
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 8
    #elif PPMPF_VXPP_I1D0 == 8
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 9
    #elif PPMPF_VXPP_I1D0 == 9
        #undef PPMPF_VXPP_I1D0
        #define PPMPF_VXPP_I1D0 0
        #define PPMPF_VXPP_I1CARRY
    #endif
#else
    #error "unexpected preprocessor error on PPMPF_VXPP_I1D0"
#endif
