...
#if defined(PPMPF_VXPP_I1D4)
    #if PPMPF_VXPP_I1D4 == 0
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 1
    #elif PPMPF_VXPP_I1D4 == 1
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 2
    #elif PPMPF_VXPP_I1D4 == 2
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 3
    #elif PPMPF_VXPP_I1D4 == 3
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 4
    #elif PPMPF_VXPP_I1D4 == 4
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 5
    #elif PPMPF_VXPP_I1D4 == 5
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 6
    #elif PPMPF_VXPP_I1D4 == 6
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 7
    #elif PPMPF_VXPP_I1D4 == 7
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 8
    #elif PPMPF_VXPP_I1D4 == 8
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 9
    #elif PPMPF_VXPP_I1D4 == 9
        #undef PPMPF_VXPP_I1D4
        #define PPMPF_VXPP_I1D4 0
        #define PPMPF_VXPP_I1CARRY
    #endif
#else
    #error "unexpected preprocessor error on PPMPF_VXPP_I1D4"
#endif
