...
#define PPMPF_VXPP_ENDR5() \
        PPMPF_DIGNM(PPMPF_TUP_SIZEOF(PPMPF_SEQ_POP(PPMPF_VXPP_SET5(/**/))))
#define PPMPF_VXPP_SLOT5() \
        PPMPF_DREF(PPMPF_SEQ_GET(PPMPF_SEQ_GET(PPMPF_VXPP_SET5(/**/))))
#define PPMPF_VXPP_ITEM5() \
        PPMPF_DREF( \
            PPMPF_TUP_ATPOS( PPMPF_SEQ_POP(PPMPF_VXPP_SN_ITEM(5)) \
