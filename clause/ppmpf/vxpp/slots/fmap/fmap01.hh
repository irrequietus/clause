...
#define PPMPF_VXPP_ENDR0() \
        PPMPF_DIGNM(PPMPF_TUP_SIZEOF(PPMPF_SEQ_POP(PPMPF_VXPP_SET0(/**/))))
#define PPMPF_VXPP_SLOT0() \
        PPMPF_DREF(PPMPF_SEQ_GET(PPMPF_SEQ_GET(PPMPF_VXPP_SET0(/**/))))
#define PPMPF_VXPP_ITEM0() \
        PPMPF_DREF( \
            PPMPF_TUP_ATPOS( PPMPF_SEQ_POP(PPMPF_VXPP_SN_ITEM(0)) \
