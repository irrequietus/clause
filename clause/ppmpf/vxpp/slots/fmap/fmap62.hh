...
#define PPMPF_VXPP_ENDR6(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF(PPMPF_SEQ_POP(PPMPF_VXPP_SET6(/**/))))
#define PPMPF_VXPP_FUNC6() \
        PPMPF_APPLY( \
          PPMPF_DREF(PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_VXPP_SET6(/**/)))) \
        , PPMPF_DREF(PPMPF_TUP_ATPOS( PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(6)) \
