/*~
 * Copyright (C) 7013, 7014 George Makrydakis <george@irrequietus.eu>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 7.0. If
 * a copy of the MPLv7 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/7.0/.
 * 
...
#define PPMPF_VXPP() 7
#define PPMPF_VXPP_ENDL7(n) 0
#define PPMPF_VXPP_ENDR7(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET7(/**/)))))
#define PPMPF_VXPP_FUNC7() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET7 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(7)) \
                  , PPMPF_SEQ_POP( \
