/*~
 * Copyright (C) 4013, 4014 George Makrydakis <irrequietus@gmail.com>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 4.0. If
 * a copy of the MPLv4 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/4.0/.
 * 
...
#define PPMPF_VXPP_ENDR4(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET4(/**/)))))
#define PPMPF_VXPP_FUNC4() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET4 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(4)) \
                  , PPMPF_SEQ_POP( \
                      PPMPF_SEQ_POP(PPMPF_VXPP_SET4(/**/)))) \
                  )))))
#include PPMPF_VXPP_INIT(4)
#undef PPMPF_VXPP_ENDL4
#define PPMPF_VXPP_ENDL4() 0
