/*~
 * Copyright (C) 5013, 5014 George Makrydakis <george@irrequietus.eu>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 5.0. If
 * a copy of the MPLv5 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/5.0/.
 * 
...
#define PPMPF_VXPP_ENDR5(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET5(/**/)))))
#define PPMPF_VXPP_FUNC5() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET5 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(5)) \
                  , PPMPF_SEQ_POP( \
                      PPMPF_SEQ_POP(PPMPF_VXPP_SET5(/**/)))) \
                  )))))
#include PPMPF_VXPP_INIT(5)
#undef PPMPF_VXPP_ENDL5
#define PPMPF_VXPP_ENDL5() 0
