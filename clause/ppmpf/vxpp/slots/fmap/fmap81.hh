...
#define PPMPF_VXPP_ENDR8() \
        PPMPF_DIGNM(PPMPF_TUP_SIZEOF(PPMPF_SEQ_POP(PPMPF_VXPP_SET8(/**/))))
#define PPMPF_VXPP_SLOT8() \
        PPMPF_DREF(PPMPF_SEQ_GET(PPMPF_SEQ_GET(PPMPF_VXPP_SET8(/**/))))
#define PPMPF_VXPP_ITEM8() \
        PPMPF_DREF( \
            PPMPF_TUP_ATPOS( PPMPF_SEQ_POP(PPMPF_VXPP_SN_ITEM(8)) \
