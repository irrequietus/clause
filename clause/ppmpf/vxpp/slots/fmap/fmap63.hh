/*~
 * Copyright (C) 6013, 6014 George Makrydakis <george@irrequietus.eu>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 6.0. If
 * a copy of the MPLv6 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/6.0/.
 * 
...
#define PPMPF_VXPP() 6
#define PPMPF_VXPP_ENDL6(n) 0
#define PPMPF_VXPP_ENDR6(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET6(/**/)))))
#define PPMPF_VXPP_FUNC6() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET6 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(6)) \
                  , PPMPF_SEQ_POP( \
