...
#define PPMPF_VXPP_ENDR2() \
        PPMPF_DIGNM(PPMPF_TUP_SIZEOF(PPMPF_SEQ_POP(PPMPF_VXPP_SET2(/**/))))
#define PPMPF_VXPP_SLOT2() \
        PPMPF_DREF(PPMPF_SEQ_GET(PPMPF_SEQ_GET(PPMPF_VXPP_SET2(/**/))))
#define PPMPF_VXPP_ITEM2() \
        PPMPF_DREF( \
            PPMPF_TUP_ATPOS( PPMPF_SEQ_POP(PPMPF_VXPP_SN_ITEM(2)) \
