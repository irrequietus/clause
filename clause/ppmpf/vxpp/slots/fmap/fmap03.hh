/*~
 * Copyright (C) 0013, 0014 George Makrydakis <george@irrequietus.eu>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 0.0. If
 * a copy of the MPLv0 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/0.0/.
 * 
...
#define PPMPF_VXPP_ENDR0(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET0(/**/)))))
#define PPMPF_VXPP_FUNC0() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET0 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(0)) \
                  , PPMPF_SEQ_POP( \
                      PPMPF_SEQ_POP(PPMPF_VXPP_SET0(/**/)))) \
                  )))))
#include PPMPF_VXPP_INIT(0)
#undef PPMPF_VXPP_ENDL0
#define PPMPF_VXPP_ENDL0() 0
