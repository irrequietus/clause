/*~
 * Copyright (C) 8013, 8014 George Makrydakis <george@irrequietus.eu>
 * 
 * This file is part of 'clause', a highly generic C++ meta-programming library,
 * subject to the terms and conditions of the Mozilla Public License v 8.0. If
 * a copy of the MPLv8 license text was not distributed with this file, you can
 * obtain it at: http://mozilla.org/MPL/8.0/.
 * 
...
#define PPMPF_VXPP_ENDR8(n) \
        PPMPF_DIGNM( \
            PPMPF_TUP_SIZEOF( \
                PPMPF_SEQ_POP(PPMPF_SEQ_POP(PPMPF_VXPP_SET8(/**/)))))
#define PPMPF_VXPP_FUNC8() \
        PPMPF_DPAR(PPMPF_SEQ_GET(PPMPF_SEQ_POP( \
          PPMPF_APPLY(PPMPF_VXPP_SET8 \
            , PPMPF_DREF( \
                PPMPF_TUP_ATPOS( \
                    PPMPF_SEQ_POP( PPMPF_VXPP_SN_ITEM(8)) \
                  , PPMPF_SEQ_POP( \
                      PPMPF_SEQ_POP(PPMPF_VXPP_SET8(/**/)))) \
                  )))))
#include PPMPF_VXPP_INIT(8)
#undef PPMPF_VXPP_ENDL8
#define PPMPF_VXPP_ENDL8() 0
