...
#ifndef _ODREEX_AMPLE_STORAGE_PACK_HH_
#define _ODREEX_AMPLE_STORAGE_PACK_HH_

#include <odreex/ample/storage/headtail.hh>
 ...
 * in <odreex/ample/storage/block.hh> but was left unused.
 */
...
public:
     ...
     * odreex::ample algorithms. The metahandlers thus offer support for the
     * following operations, "metadeployers" of which are found in the header
     * <odreex/ample/oprt/storage.hh> :
     * ------------
     * size_of
     * clear
     * push_back
...
#endif /* _ODREEX_AMPLE_STORAGE_HH_ */
